...
#    sentence_length_difference = percent_difference(get_average_sentence_length(str(textsample1)), get_average_sentence_length(str(textsample2)))
#    sentence_length_similarity = abs(1 - sentence_length_difference)
#    word_count_similarity = frequency_comparison(word_count_frequency(textample1), word_count_frequency(textsample2))
#    ngram_similarity = build_frequency_table(TextSample(self.ngram_frequency(textsample1)), TextSample(self.ngram_frequency(textsample2)))
#    final_sum = (sentence_length_similarity + word_count_similarity + ngram_similarity) / 3
#    return final_sum
...
print(str(find_text_similarity(lily_trebuchet_intro, murder_note)))
